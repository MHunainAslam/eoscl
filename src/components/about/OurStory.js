        ...
        <section>
            <div className="container pt-4">
                <p className='para d-inline-block'>
                    ...
                    <Image src={'/assets/images/banner/banner.png'} alt="" style={{height: '300px !important'}} className='mb-3 w-50 object-fit-contain float-start' width={400} height={400}></Image>
                    <br /><br />
