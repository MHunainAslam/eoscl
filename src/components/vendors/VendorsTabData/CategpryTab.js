                    ...
                    <>
                        <ul className="nav row nav-tabs border-0  " role="tablist">
                            {tabdata?.data?.map((item, i) => (
                                ...
                                <Link href={{pathname: `/partners/${item.id}`, query: {state : JSON.stringify(item.image)}}}   class={`col-lg-4 col-md-6 col-12 mx-0 mt-3 nav-item nav-link text-capitalize border-0`} >
