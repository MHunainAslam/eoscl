...
const MuslimAssociation = () => {
    return (
        <> <div className="row">
            <div className="col-lg-4 col-md-6 mt-3">
                <div className="card vendor-card h-100">
                    <div className="card-header">
                        <Image src={'/assets/images/vendors/Rectangle 34.png'} className='pt-2' width={1000} height={1000} alt=''></Image>
...
export default MuslimAssociation
